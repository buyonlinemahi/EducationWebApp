...
var defaults = {
	...
	buttonText: {
	    prev: "<span class='fc-text-arrow'  id='btnPrev'>&lsaquo;</span>",
	    next: "<span class='fc-text-arrow'  id='btnNext'>&rsaquo;</span>",
				...
				$.each(this.split(','), function(j, buttonName) {
					if (buttonName == 'title') {
						...
						if (buttonClick) {
							...
							if (text == 'month') {
							    text = 'Calander View';
							    dataaa = "<span id='btnCalanderView' class='fc-button fc-button-" + buttonName + " " + tm + "-state-default'>" +
									(icon ?
							    ...
							    dataaa = "<span class='fc-button fc-button-" + buttonName + " " + tm + "-state-default'>" +
									(icon ?
										"<span class='fc-icon-wrap'>" +
											"<span class='ui-icon ui-icon-" + icon + "'/>" +
										"</span>" :
...
function BasicView(element, calendar, viewName) {
	...
	function buildTableHTML() {
		var html =
			"<table class='fc-border-separate' style='width:100% ; border: 1px solid rgb(221, 221, 221);' cellspacing='0'>" +
			buildHeadHTML() +
			buildBodyHTML() +
			"</table>";
